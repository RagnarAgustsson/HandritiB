  ...
  return (
    <div className="min-h-screen bg-zinc-950">
      <div className="mx-auto max-w-2xl px-4 py-10">
        <Link href="/sessions" className="flex items-center gap-1 text-sm text-zinc-500 hover:text-zinc-300 mb-6 transition">
        ...
        <div className="mb-6">
          {endurnefna ? (
            <div className="flex items-center gap-2">
              ...
              />
              <button onClick={vistaEndurnefna} className="text-sm text-indigo-400 hover:text-indigo-300 transition">{tc('save')}</button>
              <button onClick={() => setEndurnefna(false)} className="text-sm text-zinc-500 hover:text-zinc-300 transition">{tc('cancel')}</button>
            </div>
          ) : (
