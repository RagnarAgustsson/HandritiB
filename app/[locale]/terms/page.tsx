...
export default async function SkilmalarPage({ params }: Props) {
      ...
      <div className="mx-auto max-w-2xl px-4 py-10">
        ...
        <div className="space-y-8 text-sm text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Handriti (hér eftir &ldquo;þjónustan&rdquo;) er hugbúnaður sem veitir gervigreindarstudda
              hljóðritun og samantekt á íslensku tali. Þjónustan er rekin af Cognia ehf.
              (netfang: handriti@gmail.com), hér eftir &ldquo;rekstraraðili&rdquo;.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p>
              Þjónustan er veitt &ldquo;eins og hún er&rdquo; (as is) án nokkurrar ábyrgðar, hvort sem
